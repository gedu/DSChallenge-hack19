...
class DetailScreen extends StatelessWidget {
  ...
  Future<List<StackOverflowQuestion>> _getData(String tag) async {
    ...
    final response = await http.get(
        'https://api.stackexchange.com/2.2/search?page=1&pagesize=10&order=desc&sort=activity&tagged=flutter&intitle=' +
            tag +
            '&site=stackoverflow&key=crMKL43ChbI5neEFEi6A)A((');
